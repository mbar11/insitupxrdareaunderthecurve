...
Be sure to import the environment (insitu.yml file) to Anaconda, and run with Spyder 5.4.1. Also assure the backend is Qt5 (Spyder settings (wrench)->IPython console->Graphics->Graphics backend-> Qt5).
